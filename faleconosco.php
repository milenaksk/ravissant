        ...
        <div class="col-md-10 mx-auto col-lg-7">
            <form class="p-4 p-md-5 border rounded-3 bg-purple text-center shadow p-3 mb-5">
                ...
                <div class="form-floating mb-3">
                    <input type="text" class="form-control" id="inputContatoName" required />
                    <label for="inputContatoName">Nome completo</label>
                </div>

                <div class="form-floating mb-3">
                    <input type="email" class="form-control" id="inputContatoEmail" required />
                    <label for="inputContatoEmail">E-mail</label>
                </div>

                <div class="form-group">
                    <label for="exampleFormControlTextarea1">Mensagem</label>
                    <textarea class="form-control" id="campoMensagem" rows="5" placeholder="Deixe sua mensagem"></textarea>
                </div>
